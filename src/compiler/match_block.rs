...
pub fn parse_match_block(lines: &[String], current_line: &mut usize, pos: SourcePosition) -> Result<Op, CompilerError> {
        ...
        if line.trim() == "value:" {
            *current_line += 1;
            ...
            let case_value = case_value_str.parse::<f64>()
                .map_err(|_| CompilerError::InvalidCaseValue(
            ...
            *current_line += 1;
            ...
            let default_block = line_parser::parse_block(lines, current_line, default_indent, default_pos)?;
