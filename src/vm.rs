...
pub struct VM {
    ...
    pub storage_backend: Option<Box<dyn StorageBackend + StorageExtensions + Send + Sync>>,
}
...
impl VM {
    ...
    pub fn with_storage_backend<S: StorageBackend + StorageExtensions + Send + Sync + 'static>(backend: S) -> Self {
        Self {
            stack: Vec::new(),
            memory: HashMap::new(),
            functions: HashMap::new(),
    ...
    pub fn set_storage_backend<T: StorageBackend + StorageExtensions + Send + Sync + 'static>(&mut self, backend: T) {
